  ...
  return (
    <nav className="navbar navbar-light bg-white shadow-sm px-3 py-2 sticky-top">
      <div className="container-fluid">
        ...
        <button className="btn border-0 d-lg-none me-2 p-0" onClick={toggleSidebar}>
          <FaBars size={22} style={{ color: "var(--primary-teal)" }} />
        </button>
        
        <h5 className="mb-0 fw-bold d-none d-sm-block" style={{ color: "var(--primary-teal)" }}>
          Admin Dashboard
        </h5>
        ...
        <div className="ms-auto d-flex align-items-center gap-3">
          ...
          <div className="text-end d-none d-md-block">
            ...
            <small className="text-muted" style={{ fontSize: '11px' }}>{userRole}</small>
          </div>
          ...
          <div className="profile-wrapper">
            {userImage ? (
              ...
              <FaUserCircle size={32} style={{ color: "var(--primary-teal)", cursor: "pointer" }} />
            )}
          </div>
        </div>
      </div>
